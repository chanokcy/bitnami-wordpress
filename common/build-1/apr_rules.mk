...
#
apr_builddir=/Applications/bitnami-wordpress/common/build-1
apr_builders=/Applications/bitnami-wordpress/common/build-1
top_builddir=/Applications/bitnami-wordpress/common/build-1
...
CPPFLAGS=-DAI_ADDRCONFIG=0 -I/bitnami/mampstackDev-osx-x64/output/sqlite/include -I/Applications/bitnami-wordpress/common/include -I/Applications/bitnami-wordpress/common/include/sasl -I/Applications/bitnami-wordpress/common/include -arch x86_64
LDFLAGS=-L/bitnami/mampstackDev-osx-x64/output/sqlite/lib -L/Applications/bitnami-wordpress/common/lib -arch x86_64 -ldl
LIBS=
DEFS=-DHAVE_CONFIG_H
