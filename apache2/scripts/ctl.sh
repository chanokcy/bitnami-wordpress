...
HTTPD_PIDFILE=/Applications/bitnami-wordpress/apache2/logs/httpd.pid



HTTPD="/Applications/bitnami-wordpress/apache2/bin/httpd -f /Applications/bitnami-wordpress/apache2/conf/httpd.conf"
if [ -f "/Applications/bitnami-wordpress/apps/bitnami/banner/disable-banner" ] ; then
...
. /Applications/bitnami-wordpress/apache2/bin/envvars
