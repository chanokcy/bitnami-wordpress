...
MYSQL_PIDFILE=/Applications/bitnami-wordpress/mysql/data/mysqld.pid

MYSQL_START="/Applications/bitnami-wordpress/mysql/bin/mysqld_safe --defaults-file=/Applications/bitnami-wordpress/mysql/my.cnf --socket=/Applications/bitnami-wordpress/mysql/tmp/mysql.sock  --datadir=/Applications/bitnami-wordpress/mysql/data --log-error=/Applications/bitnami-wordpress/mysql/data/mysqld.log  --pid-file=$MYSQL_PIDFILE --lower-case-table-names=1 "
