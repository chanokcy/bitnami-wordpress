...
if ('/Applications/bitnami-wordpress/php/lib/php ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('/Applications/bitnami-wordpress/php/lib/php '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
